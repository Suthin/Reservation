USE [master]
GO
/****** Object:  Database [Reservation]    Script Date: 1/3/2023 8:54:33 PM ******/
CREATE DATABASE [Reservation]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Reservation', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\Reservation.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Reservation_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\Reservation_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
USE [Reservation]
GO
/****** Object:  Table [dbo].[Client]    Script Date: 1/3/2023 8:54:33 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[ClientSlot]    Script Date: 1/3/2023 8:54:34 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[ClientSlot](
	[ClientSlotId] [int] IDENTITY(1,1) NOT NULL,
	[ProviderSlotId] [int] NOT NULL,
	...
	[CreatedOn] [datetime2](7) NOT NULL,
	[LastUpdatedOn] [datetime2](7) NOT NULL,
 CONSTRAINT [PK_ClientSlot] PRIMARY KEY CLUSTERED 
(
	[ClientSlotId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [dbo].[Provider]    Script Date: 1/3/2023 8:54:34 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProviderSlot]    Script Date: 1/3/2023 8:54:34 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[ProviderSlot](
	[ProviderSlotId] [int] IDENTITY(1,1) NOT NULL,
	...
	[CreatedOn] [datetime2](7) NOT NULL,
	[LastUpdatedOn] [datetime2](7) NOT NULL,
 CONSTRAINT [PK_ProviderSlot] PRIMARY KEY CLUSTERED 
(
	[ProviderSlotId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[ClientSlot]  WITH CHECK ADD  CONSTRAINT [FK_ClientSlot_Client] FOREIGN KEY([ClientId])
REFERENCES [dbo].[Client] ([ClientId])
GO
ALTER TABLE [dbo].[ClientSlot] CHECK CONSTRAINT [FK_ClientSlot_Client]
GO
ALTER TABLE [dbo].[ClientSlot]  WITH CHECK ADD  CONSTRAINT [FK_ClientSlot_ProviderSlot] FOREIGN KEY([ProviderSlotId])
REFERENCES [dbo].[ProviderSlot] ([ProviderSlotId])
GO
ALTER TABLE [dbo].[ClientSlot] CHECK CONSTRAINT [FK_ClientSlot_ProviderSlot]
GO
ALTER TABLE [dbo].[ProviderSlot]  WITH CHECK ADD  CONSTRAINT [FK_ProviderSlot_Provider] FOREIGN KEY([ProviderId])
REFERENCES [dbo].[Provider] ([ProviderId])
GO
ALTER TABLE [dbo].[ProviderSlot] CHECK CONSTRAINT [FK_ProviderSlot_Provider]
GO
USE [master]
GO
